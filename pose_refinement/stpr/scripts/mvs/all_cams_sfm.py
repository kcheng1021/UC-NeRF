...
if __name__ == '__main__':
    ...
    cmd = f"python /data/kcheng/codes/UC-NeRF-main/pose_refinement/colmap/scripts/mvsprepare_all_data_for_mvs.py --origin_path {args.origin_path} --input_path {input_path}"
    os.system(cmd)
    end_time = time.time()
    ...
    cmd = f"bash /data/kcheng/codes/UC-NeRF-main/pose_refinement/colmap/scripts/mvs/run_multi_cam_pose_opt.sh {colmap_exe_dir} {target_path} {target_path} {args.input_path} {pose_scale_path} {args.fix_trans_refine_rot}"
    os.system(cmd)
